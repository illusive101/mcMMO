...
public class mcPermissions {
    ...
    public boolean grimStrikes(Player player) {
    	return player.hasPermission("mcmmo.ability.scythes.grimstrikes");
    }
    
    public boolean slowness(Player player) {
    	return player.hasPermission("mcmmo.ability.scythes.slowness");
    }
    
    public boolean scytheCriticalCheck(Player player) {
    ...
    public boolean scythes(Player player) {
    	return player.hasPermission("mcmmo.skills.scythes");
    }
