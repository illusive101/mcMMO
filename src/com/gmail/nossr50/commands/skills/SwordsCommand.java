...
public class SwordsCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		slowpercentage = String.valueOf((skillvalue / 5000) * 100);		
		...
		player.sendMessage(mcLocale.getString("m.EffectsTemplate", new Object[] { mcLocale.getString("m.EffectsSwords7_0"), mcLocale.getString("m.EffectsSwords7_1") }));
		...
		player.sendMessage(mcLocale.getString("m.SwordsHeroicChance", new Object[] { slowpercentage }));
