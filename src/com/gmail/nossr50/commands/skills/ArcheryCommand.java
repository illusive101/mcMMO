...
public class ArcheryCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		player.sendMessage(mcLocale.getString("m.EffectsTemplate", new Object[] { mcLocale.getString("m.EffectsArchery5_0"), mcLocale.getString("m.EffectsArchery5_1") }));
		...
		player.sendMessage(mcLocale.getString("m.ArcheryFreezeChance", new Object[] { frezeepercentage }));
