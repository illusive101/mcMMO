...
public class McstatsCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (Skills.hasCombatSkills(player)) {
			...
			if (mcPermissions.getInstance().scythes(player))
				player.sendMessage(Skills.getSkillStats(mcLocale.getString("mcPlayerListener.ScythesSkill"), PP.getSkillLevel(SkillType.SCYTHES), PP.getSkillXpLevel(SkillType.SCYTHES), PP.getXpToLevel(SkillType.SCYTHES)));
		}
